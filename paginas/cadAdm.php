...
<head>
    ...
    <title>Página de cadastro - Adm</title>
                    ...
                    <div class="box" id="campos">
                        ...
                        <div class="form-row">
                            <div class="col-3 col-md-4">
                                ...
                                <select id="ddd" name="ddd" class="form-control" required>
                        ...
                        <div class="row mt-4" id="btn">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-block" onclick="window.location.href='loginAdm.php'">Cadastrar</button>
                            </div>
                        </div>
